...
<input @error($error ?? false) {!! $attributes->merge(['class' => 'rounded-md shadow-sm border-red-500 focus:border-red-500 focus:ring focus:ring-red-300 focus:ring-opacity-50 text-sm text-gray-800']) !!}
